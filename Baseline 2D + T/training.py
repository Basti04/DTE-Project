...
def train():
    ...
    # load data
    myLoader_train = DataLoader(trainingDataset, batch_size=cfg['batchSize'], num_workers=16, pin_memory=True)
    myLoader_test = DataLoader(testDataset, batch_size=cfg['batchSize'], num_workers=16, pin_memory=True)
